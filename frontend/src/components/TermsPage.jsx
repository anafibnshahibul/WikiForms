    ...
    <div className="wikiform-container" style={{ marginTop: 24, paddingBottom: 60 }}>
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border-light)', borderTop: '4px solid #3366cc', borderRadius: 2, padding: '32px' }}>
        ...
        <Section title={`1. ${T('terms_accept_title')}`}>
          <P>By using WikiForms, you agree to these Terms and our <a href="/privacy" style={{ color: '#3366cc' }}>Privacy Policy</a>.</P>
        </Section>

        <Section title="2. Service Description">
          <P>WikiForms is a free, open-source form and quiz builder hosted on <a href="https://wikitech.wikimedia.org/wiki/Portal:Toolforge" style={{ color: '#3366cc' }}>Wikimedia Toolforge</a>.</P>
        </Section>
        ...
        <Section title={`5. ${T('terms_data_title')}`}>
          <P>You retain ownership of content you create. You may delete your forms and data at any time.</P>
        </Section>

        <Section title="6. Service Availability">
          <P>WikiForms is provided "as is" without warranty. As a volunteer project, we cannot guarantee uninterrupted availability.</P>
        </Section>

        <Section title={`7. ${T('terms_liability_title')}`}>
          <P>WikiForms and its contributors are not liable for any damages arising from use of the service.</P>
        </Section>
